...
[@mks2508/better-logger](../../README.md) / [index](../README.md) / ComponentLogger

# Class: ComponentLogger

Defined in: [ScopedLogger.ts:530](https://github.com/MKS2508/advanced-logger/blob/e104f55c026f2d3d70968a0ae336428953e1505d/src/ScopedLogger.ts#L530)

Logger para componentes UI, módulos o cualquier unidad con ciclo de vida.

Extiende [ScopedLogger](ScopedLogger.md) pre-seteando el badge `COMPONENT` y exponiendo
atajos para eventos típicos: [lifecycle](#lifecycle), [stateChange](#statechange) y
...
## See
 ...
 - [Logger.component](Logger.md#component)
...
> **new ComponentLogger**(`parent`, `componentName`): `ComponentLogger`

Defined in: [ScopedLogger.ts:539](https://github.com/MKS2508/advanced-logger/blob/e104f55c026f2d3d70968a0ae336428953e1505d/src/ScopedLogger.ts#L539)
...
Nombre del componente (scope label).
...
Defined in: [ScopedLogger.ts:555](https://github.com/MKS2508/advanced-logger/blob/e104f55c026f2d3d70968a0ae336428953e1505d/src/ScopedLogger.ts#L555)
...
Nombre del evento (`mount`, `unmount`,
  `update`, ...).
...
Detalle opcional; si se omite, solo se
...
Defined in: [ScopedLogger.ts:573](https://github.com/MKS2508/advanced-logger/blob/e104f55c026f2d3d70968a0ae336428953e1505d/src/ScopedLogger.ts#L573)
...
Payload opcional asociado a la transición.
...
Defined in: [ScopedLogger.ts:593](https://github.com/MKS2508/advanced-logger/blob/e104f55c026f2d3d70968a0ae336428953e1505d/src/ScopedLogger.ts#L593)
